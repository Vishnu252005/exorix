...
function FundCardProvider({
  ...
  const handleAnalyticsAmountChanged = useCallback((amount, currency) => {
  ...
  const handleSetFundAmountFiat = useCallback(amount => {
  ...
  const handleSetSelectedPaymentMethod = useCallback(paymentMethod => {
