...
function EarnDetails({
  ...
  const _useEarnContext = useEarnContext(),
    error = _useEarnContext.error;
  if (error) {
    return /*#__PURE__*/jsxs("div", {
      className: cn('flex w-full flex-col gap-1 text-sm', color.error),
      children: [/*#__PURE__*/jsx("div", {
        className: "font-semibold",
        children: "Error fetching vault details"
      }), /*#__PURE__*/jsx("div", {
        className: "text-xs",
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    children: [/*#__PURE__*/jsx(VaultDetails, {}), /*#__PURE__*/jsx(YieldDetails, {})]
  });
}
export { EarnDetails };
