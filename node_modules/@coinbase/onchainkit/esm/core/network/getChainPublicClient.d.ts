...
export declare function getChainPublicClient(chain: Chain): {
    ...
    prepareTransactionRequest: <const request extends import("viem").PrepareTransactionRequestRequest<Chain, chainOverride_2>, chainOverride_2 extends Chain | undefined = undefined, accountOverride extends `0x${string}` | import("viem").Account | undefined = undefined>(args: import("viem").PrepareTransactionRequestParameters<Chain, import("viem").Account | undefined, chainOverride_2, accountOverride, request>) => Promise<import("viem").UnionRequiredBy<Extract<import("viem").UnionOmit<import("viem").ExtractChainFormatterParameters<import("viem").DeriveChain<Chain, chainOverride_2>, "transactionRequest", import("viem").TransactionRequest>, "from"> & (import("viem").DeriveChain<Chain, chainOverride_2> extends infer T_45 ? T_45 extends import("viem").DeriveChain<Chain, chainOverride_2> ? T_45 extends Chain ? {
        ...
        chainId?: number | undefined;
    }, (request["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? request["parameters"][number] : "type" | "chainId" | "fees" | "gas" | "nonce" | "blobVersionedHashes") extends infer T_44 ? T_44 extends (request["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? request["parameters"][number] : "type" | "chainId" | "fees" | "gas" | "nonce" | "blobVersionedHashes") ? T_44 extends "fees" ? "gasPrice" | "maxFeePerGas" | "maxPriorityFeePerGas" : T_44 : never : never> & (unknown extends request["kzg"] ? {} : Pick<request, "kzg">))[K_1]; } : never>;
    readContract: <const abi_5 extends readonly unknown[] | import("viem").Abi, functionName_1 extends import("viem").ContractFunctionName<abi_5, "pure" | "view">, const args_2 extends import("viem").ContractFunctionArgs<abi_5, "pure" | "view", functionName_1>>(args: import("viem").ReadContractParameters<abi_5, functionName_1, args_2>) => Promise<import("viem").ReadContractReturnType<abi_5, functionName_1, args_2>>;
    ...
    simulateBlocks: <const calls_1 extends readonly unknown[]>(args: import("viem/actions").SimulateBlocksParameters<calls_1>) => Promise<import("viem/actions").SimulateBlocksReturnType<calls_1>>;
    simulateCalls: <const calls_2 extends readonly unknown[]>(args: import("viem/actions").SimulateCallsParameters<calls_2>) => Promise<import("viem/actions").SimulateCallsReturnType<calls_2>>;
    ...
    extend: <const client extends {
        ...
        type?: undefined;
        uid?: undefined;
    } & import("viem").ExactPartial<Pick<import("viem").PublicActions<import("viem").HttpTransport<undefined, false>, Chain, undefined>, "getChainId" | "call" | "createContractEventFilter" | "createEventFilter" | "estimateContractGas" | "estimateGas" | "getBlock" | "getBlockNumber" | "getContractEvents" | "getEnsText" | "getFilterChanges" | "getGasPrice" | "getLogs" | "getTransaction" | "getTransactionCount" | "getTransactionReceipt" | "prepareTransactionRequest" | "readContract" | "sendRawTransaction" | "simulateContract" | "uninstallFilter" | "watchBlockNumber" | "watchContractEvent"> & Pick<import("viem").WalletActions<Chain, undefined>, "sendTransaction" | "writeContract">>>(fn: (client: import("viem").Client<import("viem").HttpTransport<undefined, false>, Chain, undefined, import("viem").PublicRpcSchema, import("viem").PublicActions<import("viem").HttpTransport<undefined, false>, Chain>>) => client) => import("viem").Client<import("viem").HttpTransport<undefined, false>, Chain, undefined, import("viem").PublicRpcSchema, { [K_2 in keyof client]: client[K_2]; } & import("viem").PublicActions<import("viem").HttpTransport<undefined, false>, Chain>>;
};
