 ...
 */
export declare const getOnchainKitConfig: <K extends keyof OnchainKitConfig>(configName: K) => (typeof ONCHAIN_KIT_CONFIG)[K];
/**
 * Update the ONCHAIN_KIT_CONFIG object directly by providing the properties to update.
 * This is powerful when you use OnchainKit utilities outside of the React context.
 */
export declare const setOnchainKitConfig: (properties: SetOnchainKitConfig) => <K extends keyof OnchainKitConfig>(configName: K) => (typeof ONCHAIN_KIT_CONFIG)[K];
