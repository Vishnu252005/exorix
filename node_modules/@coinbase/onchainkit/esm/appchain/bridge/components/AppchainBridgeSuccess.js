...
import { color, cn, text, pressable, border } from '../../../styles/theme.js';
...
const AppchainBridgeSuccess = ({
  ...
  const _useAppchainBridgeCon = useAppchainBridgeContext(),
    handleOpenExplorer = _useAppchainBridgeCon.handleOpenExplorer,
      ...
      children: /*#__PURE__*/jsxs("div", {
        ...
        children: [/*#__PURE__*/jsxs("div", {
          ...
          children: [/*#__PURE__*/jsx("div", {
            ...
            className: "ock-text-foreground flex-1 text-center font-medium text-sm",
            children: title
          })]
        }), /*#__PURE__*/jsx("div", {
          ...
          children: [{
            ...
            className: cn(pressable[variant], border.radius, 'w-full rounded-xl', 'px-4 py-3 text-base text-white leading-6', text.label1),
            type: "button",
            onClick: action,
            children: /*#__PURE__*/jsx("div", {
              className: cn(text.headline, textColor, 'flex justify-center'),
              children: label
            })
          }, label))
        })]
