...
import { useAppchainBridgeContext, AppchainBridgeProvider } from './AppchainBridgeProvider.js';
...
const AppchainBridgeDefaultContent = ({
  ...
  const _useAppchainBridgeCon = useAppchainBridgeContext(),
    isAddressModalOpen = _useAppchainBridgeCon.isAddressModalOpen,
    isWithdrawModalOpen = _useAppchainBridgeCon.isWithdrawModalOpen,
    isSuccessModalOpen = _useAppchainBridgeCon.isSuccessModalOpen,
    isResumeTransactionModalOpen = _useAppchainBridgeCon.isResumeTransactionModalOpen,
    setIsResumeTransactionModalOpen = _useAppchainBridgeCon.setIsResumeTransactionModalOpen;
  if (isResumeTransactionModalOpen) {
    return /*#__PURE__*/jsx("div", {
      ...
      children: /*#__PURE__*/jsx("div", {
        className: "w-full",
        children: /*#__PURE__*/jsx(AppchainBridgeResumeTransaction, {})
      })
    });
  }
  if (isSuccessModalOpen) {
    return /*#__PURE__*/jsx("div", {
      ...
      children: /*#__PURE__*/jsx("div", {
        className: "w-full",
        children: /*#__PURE__*/jsx(AppchainBridgeSuccess, {})
      })
    });
  }
  if (isWithdrawModalOpen) {
    return /*#__PURE__*/jsx("div", {
      ...
      children: /*#__PURE__*/jsx("div", {
        className: "w-full",
        children: /*#__PURE__*/jsx(AppchainBridgeWithdraw, {})
      })
    });
  }
  if (isAddressModalOpen) {
    return /*#__PURE__*/jsx("div", {
      ...
      children: /*#__PURE__*/jsx("div", {
        className: "w-full",
        children: /*#__PURE__*/jsx(AppchainBridgeAddressInput, {})
      })
    });
  }
  return /*#__PURE__*/jsx("div", {
    ...
    children: /*#__PURE__*/jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxs("div", {
        ...
        children: [/*#__PURE__*/jsx("h3", {
          ...
          className: cn(text.label2, color.foregroundMuted, 'absolute right-0'),
        ...
        children: [/*#__PURE__*/jsxs("div", {
          ...
          children: [/*#__PURE__*/jsx(AppchainBridgeNetwork, {
            type: "from",
            label: "From"
          }), /*#__PURE__*/jsx(AppchainNetworkToggleButton, {}), /*#__PURE__*/jsx(AppchainBridgeNetwork, {
            type: "to",
            label: "To"
          })]
        }), /*#__PURE__*/jsx(AppchainBridgeInput, {}), /*#__PURE__*/jsx(AppchainBridgeTransactionButton, {})]
      })]
    })
  });
};
function AppchainBridge({
  ...
  title = 'Bridge',
  bridgeableTokens,
  children = /*#__PURE__*/jsx(AppchainBridgeDefaultContent, {
    title: title
  }),
  className,
  handleFetchPrice
  ...
  return /*#__PURE__*/jsx(AppchainBridgeProvider, {
    chain: chain,
    appchain: appchain,
    bridgeableTokens: bridgeableTokens,
    handleFetchPrice: handleFetchPrice,
    children: /*#__PURE__*/jsx("div", {
      className: cn(componentTheme, background.default, border.radius, color.foreground, 'ock-border-line-default flex w-full flex-col border px-6 pt-6 pb-4', className),
      "data-testid": "ockAppchainBridge_Container",
      children: children
    })
  });
}
export { AppchainBridge };
