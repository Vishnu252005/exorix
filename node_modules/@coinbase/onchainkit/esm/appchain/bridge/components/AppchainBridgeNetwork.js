...
const AppchainBridgeNetwork = ({
  ...
  const _useAppchainBridgeCon = useAppchainBridgeContext(),
    from = _useAppchainBridgeCon.from,
  ...
  return /*#__PURE__*/jsx("div", {
    className: cn(background.secondary, border.radius, 'box-border flex h-[80px] w-full flex-col items-start justify-center p-4'),
    "data-testid": "ockAppchainBridgeNetwork_Container",
    children: /*#__PURE__*/jsx("div", {
      className: "flex w-full items-center justify-between",
      children: /*#__PURE__*/jsxs("div", {
        className: cn('flex-col items-center gap-2 p-3', border.radius, 'w-full', {
        ...
        children: [/*#__PURE__*/jsx("div", {
          ...
          children: /*#__PURE__*/jsx("span", {
            className: cn(text.label2, 'text-[#8A919E]'),
            children: label
          })
        }), /*#__PURE__*/jsxs("div", {
