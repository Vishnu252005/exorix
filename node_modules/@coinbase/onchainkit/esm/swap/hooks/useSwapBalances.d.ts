...
export declare function useSwapBalances({ address, fromToken, toToken, }: {
    ...
    fromTokenResponse: {
        ...
        isStale: boolean;
        refetch: (options?: import("@tanstack/react-query").RefetchOptions | undefined) => Promise<import("@tanstack/react-query").QueryObserverResult<{
            decimals: number;
            formatted: string;
            symbol: string;
            value: bigint;
        ...
        isRefetching: boolean;
        isStale: boolean;
        refetch: (options?: import("@tanstack/react-query").RefetchOptions | undefined) => Promise<import("@tanstack/react-query").QueryObserverResult<unknown, import("viem").ReadContractErrorType>>;
        fetchStatus: import("@tanstack/react-query").FetchStatus;
