...
function SwapSettingsSlippageInput({
  ...
  }, [lifecycleStatus.statusData.maxSlippage, updateLifecycleStatus, handleAnalyticsSlippageChange]);
  ...
  return /*#__PURE__*/jsxs("section", {
    className: cn(background.default, border.defaultActive, border.radius, 'flex items-center gap-2 flex-grow max-sm:pt-4', className),
