...
function SwapProvider({
  ...
  sendAnalytics, paymaster, from.amount, from.token?.symbol, to.token?.symbol, address]);
  useEffect(() => {
  ...
  }, [accountConfig, address, chainId, from.amount, from.token, isSponsored, lifecycleStatus, paymaster, sendCallsAsync, sendTransactionAsync, switchChainAsync, to.token, updateLifecycleStatus, useAggregator, walletCapabilities, sendAnalytics]);
