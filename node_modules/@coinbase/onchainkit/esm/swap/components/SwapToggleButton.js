...
function SwapToggleButton({
  ...
  return /*#__PURE__*/jsx("button", {
    type: "button",
    className: cn(pressable.alternate, border.default, '-my-6 relative mx-auto', 'flex h-12 w-12 items-center justify-center', 'rounded-lg border-4 border-solid', className),
