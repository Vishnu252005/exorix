...
function SwapDefaultContent({
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(SwapSettings, {}), /*#__PURE__*/jsx(SwapAmountInput, {
      label: "Sell",
...
function Swap({
  ...
  return /*#__PURE__*/jsx(SwapProvider, {
    ...
    children: /*#__PURE__*/jsxs("div", {
      className: cn(componentTheme, background.default, border.radius, color.foreground, 'relative flex w-full max-w-[500px] flex-col px-6 pt-6 pb-4', className),
      ...
      }), children ?? /*#__PURE__*/jsx(SwapDefaultContent, {
        to: to,
        from: from,
        disabled: disabled
      })]
