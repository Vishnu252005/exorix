...
function isWalletInstalled(walletType) {
  ...
  switch (walletType) {
    case 'phantom':
      return !!window.phantom?.ethereum?.isPhantom || !!window.ethereum.isPhantom;
    case 'rabby':
...
export { WALLET_INSTALL_URLS, checkWalletAndRedirect, isWalletInstalled, redirectToWalletInstall };
