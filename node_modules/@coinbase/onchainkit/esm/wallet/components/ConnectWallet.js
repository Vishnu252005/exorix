...
const connectWalletDefaultChildren = /*#__PURE__*/jsxs(Fragment, {
...
function ConnectWallet({
  ...
  const _useAccount = useAccount(),
    ...
    accountConnector = _useAccount.connector;
  ...
  const handleAnalyticsInitiated = useCallback(component => {
    sendAnalytics(WalletEvent.ConnectInitiated, {
      component
    });
  }, [sendAnalytics]);
  const handleAnalyticsSuccess = useCallback(walletAddress => {
  ...
  }, [config?.wallet?.display, accountAddress, connect, connector, handleAnalyticsError, handleAnalyticsInitiated, handleAnalyticsSuccess, handleOpenConnectModal, onConnect]);
  if (status === 'disconnected') {
    return /*#__PURE__*/jsxs("div", {
      ...
      children: [/*#__PURE__*/jsx(ConnectButton, {
        ...
        text: text$1
      }), config?.wallet?.display === 'modal' && /*#__PURE__*/jsx(WalletModal, {
        isOpen: isModalOpen,
