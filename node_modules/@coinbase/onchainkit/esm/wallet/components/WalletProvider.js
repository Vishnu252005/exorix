...
function WalletProvider({
  ...
  const _useState11 = useState(null),
    ...
    activeFeature = _useState12[0],
    setActiveFeature = _useState12[1];
  const _useState13 = useState(false),
    _useState14 = _slicedToArray(_useState13, 2),
    isActiveFeatureClosing = _useState14[0],
    setIsActiveFeatureClosing = _useState14[1];
  ...
  }, [address, chain, breakpoint, isConnectModalOpen, isSubComponentOpen, isSubComponentClosing, handleClose, showSubComponentAbove, alignSubComponentRight, activeFeature, isActiveFeatureClosing, animations]);
