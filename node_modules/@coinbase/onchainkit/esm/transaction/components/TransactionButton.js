...
function TransactionButton({
  ...
  return /*#__PURE__*/jsx("button", {
    className: cn(pressable.primary, border.radius, 'w-full rounded-xl', 'px-4 py-3 font-medium leading-6', isDisabled && pressable.disabled, text.headline, color.inverse, className),
