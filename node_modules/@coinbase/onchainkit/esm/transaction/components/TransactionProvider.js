...
function TransactionProvider({
  ...
  const _useSendCalls = useSendCalls({
    ...
    resetSendCalls = _useSendCalls.reset;
  const _useSendCall = useSendCall({
    ...
    resetSendCall = _useSendCall.reset;
  ...
  }, [transactions, transactionCount, transactionHashList, getTransactionLegacyReceipts]);
  ...
  }, [receipt, handleAnalytics, isSponsored, paymaster, account.address, errorCode]);
