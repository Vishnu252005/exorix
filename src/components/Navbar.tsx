...
import { Menu, X, Moon, Sun, UserCircle, LogOut, Bell, User, ChevronDown, ChevronUp, MessageSquare } from 'lucide-react';
            ...
            <div className="px-4 py-2 space-y-1">
              ...
              {user ? (
                <>
                  <Link
                    to="/profile"
                    className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-indigo-400 hover:bg-gray-800/50 rounded-lg transition-colors"
                    onClick={() => setIsOpen(false)}
                  >
                    Your Profile
                  </Link>
                  <button
                    onClick={handleLogout}
                    className="w-full text-left px-3 py-2 text-base font-medium text-red-400 hover:bg-gray-800/50 rounded-lg transition-colors flex items-center space-x-2"
                  >
                ...
                <>
                  ...
                  <Link
                    to="/signup"
                    className="block px-3 py-2 text-base font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors"
                    onClick={() => setIsOpen(false)}
                  >
                    Sign Up
                  </Link>
