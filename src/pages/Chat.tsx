...
import { collection, addDoc, query, orderBy, limit, onSnapshot, serverTimestamp, where, getDocs, updateDoc, doc, deleteDoc } from 'firebase/firestore';
                  ...
                  {messages.map((message) => (
                    <motion.div
                      ...
                      className={`flex items-start space-x-3 group relative ${
                        message.isAI ? 'bg-gray-800/30 rounded-lg p-4 border border-gray-700/50' : ''
                      }`}
                    >
